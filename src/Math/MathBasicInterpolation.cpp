...
//{
//  double varX_min = tb_ptr->varXmin();
//  double varY_min = tb_ptr->varYmin();
//  double dX = tb_ptr->getdvarX();
//  double dY = tb_ptr->getdvarY();
//  int tb_sizeX = tb_ptr->tbsizeX();
//  int tb_sizeY = tb_ptr->tbsizeY();
//
...
//    }
//
//  double f00 = tb_ptr->tbdata(idx_X, idx_Y);
//  double f10 = tb_ptr->tbdata(idx_X+1, idx_Y);
//  double f01 = tb_ptr->tbdata(idx_X, idx_Y+1);
//  double f11 = tb_ptr->tbdata(idx_X+1, idx_Y+1);
