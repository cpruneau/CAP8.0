...
//int RunAna(TString configFile="PHSD/RunAna.ini",
//           TString histogramPath="PHSD/",
//           long seed=1121331)
int main()
//int RunAna(TString configFile="Pythia/pp_13.7TeV/RA.ini",
...
//           long seed=1121331)
{
  ...
  configuration.importFrom(configurationPath,configurationFile);
...
void loadBase(const TString & includeBasePath)
{
  ...
  gSystem->Load(includePath+"TaskExceptions.hpp");
