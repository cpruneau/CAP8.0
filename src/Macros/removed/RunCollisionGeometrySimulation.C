...
int RunCollisionGeometrySimulation()
{
  ...
  EventIterator->setNEventRequested(10000000);
  EventIterator->setNEventReported(100000);
  EventIterator->setReportLevel(messageLevel);
  EventIterator->setNEventPartialSave(100000);
  EventIterator->setPartialSave(true);
  EventIterator->setSubsampleAnalysis(true);
  ...
  EventIterator->addSubtask( collisionGeometryGenerator );
  EventIterator->addSubtask( collisionGeometryAnalyzer );
  EventIterator->run();
}
