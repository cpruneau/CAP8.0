...
namespace CAP
{
  ...
  dpt_nbins  = configuration.valueInt(createKey(taskName,objectType,"dpt_nbins"));
  dpt_min    = configuration.valueDouble(createKey(taskName,objectType,"dpt_min"));
  dpt_max    = configuration.valueDouble(createKey(taskName,objectType,"dpt_max"));

  Dphi_nbins = configuration.valueInt(createKey(taskName,objectType,"Dphi_nbins"));
  Dphi_min   = configuration.valueDouble(createKey(taskName,objectType,"Dphi_min"));
  Dphi_max   = configuration.valueDouble(createKey(taskName,objectType,"Dphi_max"));
  ...
  Deta_nbins = configuration.valueInt(createKey(taskName,objectType,"Deta_nbins"));
  Deta_min   = configuration.valueDouble(createKey(taskName,objectType,"Deta_min"));
  Deta_max   = configuration.valueDouble(createKey(taskName,objectType,"Deta_max"));

  Drapidity_nbins = configuration.valueInt(createKey(taskName,objectType,"Drapidity_nbins"));
  Drapidity_min   = configuration.valueDouble(createKey(taskName,objectType,"Drapidity_min"));
  Drapidity_max   = configuration.valueDouble(createKey(taskName,objectType,"Drapidity_max"));
  }
  ...
  double recoY    = recoMomentum.rapidity();
  ...
  double genY     = genMomentum.rapidity();
